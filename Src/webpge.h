...
"<p><label for='txtDns'>DNS服务器:</label><input type='text' id='txtDns' name='dns' size='16' /></p>"\
"<p><label for='txtser'>串口波特率:</label><input type='text' id='txtser' name='ser' size='16' /></p>"\
"<p><label for='txtser_num'>串口:</label><input type='text' id='txtser_num' name='ser_num' size='16' /></p>"\
