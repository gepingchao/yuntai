...
/*
unsigned int monitor_Spent_Time;
unsigned int monitor_Start_Time;
unsigned int monitor_Totall_Time
...
void my_mem_set(char * mem, unsigned char value, unsigned short length);
